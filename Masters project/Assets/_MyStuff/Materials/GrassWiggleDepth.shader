...
Shader "GrassWiggleDepth"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 appendResult124 = (float4(-_FlameFlickerSpeed , -_FlameFlickerSpeed , -_FlameFlickerSpeed , 0.0));
			float3 ase_worldPos = i.worldPos;
			float4 appendResult113 = (float4(ase_worldPos.x , ase_worldPos.y , ase_worldPos.z , 0.0));
			float2 panner125 = ( mulTime123 * appendResult124.xy + ( ( appendResult113 * _WorldPosMultiplier ) + float4( ( _NoiseScale * i.uv_texcoord ), 0.0 , 0.0 ) ).xy);
...
/*ASEBEGIN
Version=17000
446;369;1274;597;824.8733;1172.847;1.3;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;112;-4845.383,1379.705;Float;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TextureCoordinatesNode;117;-4596.652,1734.596;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-4732.254,1909.907;Float;False;Property;_FlameFlickerSpeed;FlameFlickerSpeed;5;0;Create;True;0;0;False;0;0.2;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.NegateNode;118;-4487.665,1943.289;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-2811.447,-3431.075;Float;False;Property;_Float2;Float 2;10;0;Create;True;0;0;False;0;0;74.5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8DDC0D900259B3F57EF76B2E523A72EA790C07C9